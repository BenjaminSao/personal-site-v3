...
const { placeholderImageBox } = styles;
                ...
                <div className="grid md:grid-cols-2 items-center gap-16 md:gap-48 ">
                    <div>
                        ...
                        <p>
                            ...
                            specializing in Machine Learning and Data Mining and
                    ...
                    <div className="grid grid-cols-2">
                        <div
                            className={`${placeholderImageBox} mb-4 md:mb-10 col-span-2 md:col-span-1`}
                        ></div>
                        <div
                            className={`${placeholderImageBox} col-span-2 mb-4 md:mb-10`}
                        ></div>
                        <div></div>
                        <div
                            className={`${placeholderImageBox} col-span-2 md:col-span-1`}
                        ></div>
                    </div>
                </div>
            </div>
